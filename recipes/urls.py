...
urlpatterns = [
    ...
    path(
        "submit-recipe/<int:pk>/add-ingredient",
        views.IngredientCreate.as_view(),
        name="add-ingredient",
    ),
    path(
        "submit-recipe/<int:pk>/add-instruction",
        views.InstructionCreate.as_view(),
        name="add-instruction",
    ),
    path(
        "submit-recipe/<int:pk>/update_recipe",
        views.RecipeUpdate.as_view(),
        name="update-recipe",
    ),
    path(
        "submit-recipe/<int:pk>/update_ingredient",
        views.IngredientUpdate.as_view(),
        name="update-ingredient",
    ),
    path(
        "submit-recipe/<int:pk>/update_instruction",
    ...
    path(
        "submit-recipe/<int:pk>/delete_ingredient",
        views.IngredientDelete.as_view(),
        name="delete-ingredient",
    ),
    path(
        "submit-recipe/<int:pk>/delete_instruction",
